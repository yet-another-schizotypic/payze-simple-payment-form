...
class Payze_Simple_Payment_Form {
	...
	public function __construct() {
		if ( defined( 'PAYZE_SIMPLE_PAYMENT_FORMVERSION' ) ) {
			$this->version = PAYZE_SIMPLE_PAYMENT_FORMVERSION;
		} else {
			$this->version = '1.0.0';
		}
	 ...
	 * - Payze_Simple_Payment_Form_Admin. Defines all hooks for the admin area.
